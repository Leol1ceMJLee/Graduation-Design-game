...
public class Tertris extends JFrame implements KeyListener {
    ...
    public void initExplainPanel() {
        ...
        explain_left.add(new JLabel("左键为方块向左移动"));
        explain_left.add(new JLabel("右键为方块向右移动"));
        explain_left.add(new JLabel("下键方块下落"));
